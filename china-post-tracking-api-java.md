China Post Tracking API - Java
================================
Use Java to track China Post shipments with China Post Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.chinapost;
    ...
    public class CreateChinaPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("EE950677712TW");
                createTrackingParams.setCourierCode("china-post");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateChinaPostTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("RG022754039CN");
                createTrackingParams1.setCourierCode("china-post");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("AM247540919CN");
                createTrackingParams2.setCourierCode("china-post");
...
Get status of the shipment:
    ...
    public class GetChinaPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("RG022754039CN,AM247540919CN");
                trackingParams.setCourierCode("china-post");
...
Update a tracking by ID:
    ...
    public class UpdateChinaPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "99e6cc563ad7533c56262b104007e751";
