...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "RG022754039CN","courier_code"=>"china-post"},{"tracking_number" => "AM247540919CN","courier_code"=>"china-post"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"china-post"}
      # params  = {"tracking_numbers" => "AM247540919CN,RG022754039CN","courier_code"=>"china-post"}
...
Update a tracking by ID:
    ...
    begin
      ...
      id_string = '99e6cc563ad7533c56262b104007e751'
