China Post Tracking API - .Net
================================
Use .Net to track China Post shipments with China Post Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "EE950677712TW";
                  createTrackingParams.courierCode = "china-post";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "AM247540919CN,RG022754039CN";
                  getTrackingResultsParams.courierCode = "china-post";
